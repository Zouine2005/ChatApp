    ...
    >
        ...
        <div @class([
            ...
            @if ($message->voice_message_path)
                <audio controls>
                    <source src="{{ Storage::url($message->voice_message_path) }}" type="audio/wav">
    ...
    <footer class="shrink-0 z-10 bg-white inset-x-0">
        <div class="p-2 border-t">
            ...
            <div class="mt-2 grid grid-cols-12 gap-2">
                <button @click="startRecording" id="recordButton" class="col-span-6 bg-blue-500 text-white py-2 px-4 rounded">Record</button>
                <button @click="stopRecording" id="stopButton" class="col-span-6 bg-red-500 text-white py-2 px-4 rounded" disabled>Stop</button>
            </div>
        </div>
        <script>
            let mediaRecorder;
            ...
            async function startRecording() {
                ...
                mediaRecorder.onstop = async () => {
                    ...
                    // Replace with your server endpoint and method to handle the voice message upload
                    await fetch('/upload-voice-message', {
                        method: 'POST',
                        body: formData,
                    });
                };
